...
void Game::Initialise(void) {
	...
	this->player1->LoadStats(MUL_16(this->background_map->getTileMap()->getTilemapWidth())/data["screen"]["scale"], MUL_16(this->background_map->getTileMap()->getTilemapHeight()), this->stats_display_height_offset);
