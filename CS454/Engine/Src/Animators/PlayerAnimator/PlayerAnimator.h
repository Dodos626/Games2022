...
private:
	...
	bool set_total_animations = true; // used only on forced animations
public:
	...
	bool renderNframesOfAnimationWithFixFrame(int target_x, int target_y, double curr_time, int n_frames);
